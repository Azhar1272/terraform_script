...
url = "https://4918734.suitetalk.api.netsuite.com/services/rest/record/v1/prchaseorder/"

response = requests.get(account_id=account_id,consumer_key=consumer_key,consumer_secret=consumer_secret,token=token,token_secret=token_secret,url=url)
