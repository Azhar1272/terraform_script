...
response = json.dumps(getRestApi(account_id=account_id, consumer_key=consumer_key, consumer_secret=consumer_secret, token=token,
                      token_secret=token_secret, url=url))
...
for i in dict_response['items']:
    id  = i['id']
    record = json.dumps(getRestApi(account_id=account_id, consumer_key=consumer_key, consumer_secret=consumer_secret, token=token,
               token_secret=token_secret, url=url+'/'+id))
    print(record)
